...
import ReviewImg1 from '../assets/img/other/review-1.png';
import ReviewImg2 from '../assets/img/other/review-2.png';
          ...
          <div className="reviews__comment--list d-flex">
            ...
            <span className="reviews__summary--caption" style={{color:'#000', fontSize:'13px'}}>February 23</span>
              ...
              <div className='review-imges my-3'>
                     <img src={ReviewImg1} className='mx-2 img-fluid' style={{width:'100px'}}/>
                     <img src={ReviewImg2} className='mx-2 img-fluid' style={{width:'100px'}}/>
