...
export default function SimilarProductsSlide() {
...
<div className='d-flex justify-content-center'>
   <p style={{color:'#000', fontSize:'13px', backgroundColor:'#D2F1FE', marginTop:'30px', marginBottom:'10px', fontWeight:'500', borderRadius:'20px', padding:'8px 20px', }} className='btn'>Today's deal</p>
    </div> 
   
<h2 className='' style={{fontWeight: '600', textAlign:'center', color:'#0B0C10', marginTop:'20px', marginBottom:'30px'}}>Similar Stickers</h2>
    <style>
      {`
      .slick-arrow {
