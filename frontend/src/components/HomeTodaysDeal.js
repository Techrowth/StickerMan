...
export default function HomeTodaysDeal() {
...
<h2 className='' style={{fontWeight: '600', textAlign:'center', color:'#0B0C10', marginTop:'20px', marginBottom:'30px'}}>Today’s Deal</h2>
    <style>
      {`
      .slick-arrow {
